      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            {/* Full Name */}
            <div>
              <label htmlFor="name" className="block text-sm font-semibold leading-6 text-dark-gray">
                Full name
              </label>
            ...
            {/* Email Address */}
            <div>
              <label htmlFor="email" className="block text-sm font-semibold leading-6 text-dark-gray">
                Email address
              </label>
              <div className="mt-2.5">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="subject" className="block text-sm font-semibold leading-6 text-dark-gray">
                Subject
              </label>
              <div className="mt-2.5">
            ...
            {/* Message */}
            <div className="sm:col-span-2">
              <label htmlFor="message" className="block text-sm font-semibold leading-6 text-dark-gray">
                Message
              </label>
              <div className="mt-2.5">
