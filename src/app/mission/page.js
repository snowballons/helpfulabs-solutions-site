      ...
      <div className="bg-white dark:bg-gray-800 py-16 sm:py-24">
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-2 font-display text-4xl font-bold tracking-tight text-dark-gray dark:text-white sm:text-5xl">
            ...
            <p className="mt-6 text-lg leading-8 text-medium-gray dark:text-gray-400">
              ...
              <span className="font-semibold text-dark-gray dark:text-white"> Helpfulabs Solutions exists to break down that barrier.</span>
            </p>
          </div>

          <div className="mx-auto mt-16 max-w-4xl text-base leading-7 text-medium-gray dark:text-gray-400 text-justify sm:text-lg sm:leading-8">
            <p>
      ...
      <div className="bg-white dark:bg-gray-800 py-16 sm:py-24">
          <div className="container mx-auto px-6 max-w-4xl">
              <div className="mx-auto text-center">
                  <h2 className="font-display text-3xl font-bold tracking-tight text-dark-gray dark:text-white sm:text-4xl">The Future We&apos;re Building</h2>
